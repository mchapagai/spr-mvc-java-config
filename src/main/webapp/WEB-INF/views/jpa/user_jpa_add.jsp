		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				...
				<form:form class="form-horizontal" role="form" method="POST"
					id="user" commandName="user" action="add">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" class="form-control" id="birthdate" path="birthdate" placeholder="Date of Birth" />
							<form:errors path="birthdate" cssClass="text-danger" />
						</div>
					</div>

					<div class="col-sm-3 col-md-offset-5">
						<button class="btn btn-primary btn-block" type="submit"><spring:message code="contact.form.button" />
						</button>
					</div>
				</form:form>
			</div>
